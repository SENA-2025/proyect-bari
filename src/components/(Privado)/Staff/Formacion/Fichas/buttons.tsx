...
// Componentes
const Search = dynamic(() => import("@/components/(Privado)/Staff/Formacion/Fichas/search"));
const Create = dynamic(() => import("@/components/(Privado)/Staff/Formacion/Fichas/create"));

export default function FichasButtons() {
	return (
