...
// Componentes
// const Form = dynamic(() => import("@/components/(Privado)/Staff/Admin/Coordinadores/create/form"), { ssr: false });
	...
	return (
		<>
			...
			>
				...
				<span className="whitespace-nowrap transition-all duration-300 ease-in-out select-none">Crear Coordinador</span>
			</button>
