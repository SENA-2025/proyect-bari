...
const Search = dynamic(() => import("@/components/(Privado)/Staff/Admin/Coordinadores/search"));
const Create = dynamic(() => import("@/components/(Privado)/Staff/Admin/Coordinadores/create"));

export default function CoordinadoresButtons() {
	return (
