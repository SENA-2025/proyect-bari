...
const Search = dynamic(() => import("@/components/(Privado)/Staff/Admin/Administradores/search"));
const Create = dynamic(() => import("@/components/(Privado)/Staff/Admin/Administradores/create"));

export default function AdministradoresButtons() {
	return (
