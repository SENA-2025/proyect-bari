...
// Componentes
// const Form = dynamic(() => import("@/components/(Privado)/Staff/Coordinacion/Sedes/create/form"), { ssr: false });
	...
	return (
		<>
			...
			>
				...
				<span className="whitespace-nowrap transition-all duration-300 ease-in-out select-none">Crear Sede</span>
			</button>
