...
// Componentes
const Search = dynamic(() => import("@/components/(Privado)/Staff/Coordinacion/Centros/search"));
const Create = dynamic(() => import("@/components/(Privado)/Staff/Coordinacion/Centros/create"));
