...
// Componentes
const Search = dynamic(() => import("@/components/(Privado)/Staff/Coordinacion/Instructores/search"));
const Create = dynamic(() => import("@/components/(Privado)/Staff/Coordinacion/Instructores/create"));
