...
// (REMOVED "suspense" FROM IMPORT TO PREVENT BUILD ISSUES)i import { Suspense, useEffect, useRef, useState } from "react";
	...
	return (
		<>
			...
			>
				...
				<span className="whitespace-nowrap transition-all duration-300 ease-in-out select-none">Crear Instructor</span>
			</button>
