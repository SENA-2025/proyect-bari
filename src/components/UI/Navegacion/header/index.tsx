...
export default function Header() {
	return (
		<header className="animate-fade-in-down animate-duration-300 z-20 h-14 w-full shrink-0 bg-white shadow-sm transition-all duration-300 ease-in-out lg:h-16">
